...
fn test_streaming_code_ranges() {
    ...
    assert!(codes::STREAMING_OK >= 200 && codes::STREAMING_OK < 300);
    assert!(codes::CHECK_SEND >= 200 && codes::CHECK_SEND < 300);
    assert!(codes::TAKETHIS_RECEIVED >= 200 && codes::TAKETHIS_RECEIVED < 300);
    assert!(codes::CHECK_LATER >= 400 && codes::CHECK_LATER < 500);
    assert!(codes::CHECK_NOT_WANTED >= 400 && codes::CHECK_NOT_WANTED < 500);
    assert!(codes::TAKETHIS_REJECTED >= 400 && codes::TAKETHIS_REJECTED < 500);
}
