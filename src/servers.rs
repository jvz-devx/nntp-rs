...
//! let configs = vec![
//!     ServerConfig::tls("news-primary.com", 563, "user", "pass"),
//!     ServerConfig::tls("news-backup.com", 563, "user", "pass"),
//! ];
//!
...
struct ServerEntry {
    ...
    #[allow(dead_code)] // Kept for future use (e.g., reconnection, server info)
    config: ServerConfig,
...
/// let group = ServerGroup::new(
///     vec![
///         ServerConfig::tls("news1.example.com", 563, "user", "pass"),
///         ServerConfig::tls("news2.example.com", 563, "user", "pass"),
///     ],
